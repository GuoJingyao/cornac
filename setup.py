...
extensions = [
    ...
    Extension(name='cornac.models.pmf.pmf',
              ...
              language='c++'),
    Extension(name='cornac.models.pmf_seperable.pmf_seperable',
              sources=['cornac/models/pmf_seperable/cython/pmf_seperable' + ext],
              language='c++'),
    ...
    Extension(name='cornac.models.bpr.recom_bpr',
              ...
              language='c++',
              extra_compile_args=compile_args, extra_link_args=link_args),
    Extension(name='cornac.models.bpr_seperable.recom_bpr_seperable',
              sources=['cornac/models/bpr_seperable/recom_bpr_seperable' + ext],
              include_dirs=[np.get_include()],
              language='c++',
              extra_compile_args=compile_args, extra_link_args=link_args),
